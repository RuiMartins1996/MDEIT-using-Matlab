function file_name = model_parameters_to_mesh_name(mesh_parameters,model_folder)
...
[hash_str, short_hash_str] = encodeModelParameters(mesh_parameters);
...
file_name = strcat(...
    strcat(model_folder,'/mesh_',short_hash_str,'.mat'));

% Sanity check
S = decodeModelParameters(hash_str);

if not(compare_structs(S, mesh_parameters))
