%% EXAMPLE (2D): Bayesian optimization of sensor positions on a circle (MDEIT)
%
...
model_parameters.numOfElectrodesPerRing = 2;
...
model_parameters.material.position = ...
    [-sqrt((model_parameters.radius/2)^2/2), -sqrt((model_parameters.radius/2)^2/2), 0];
...
inv_Gamma_prior = spdiags(1./prior_variance,0,n_elem,n_elem); %#ok<NASGU>
...
save(fullfile(script_folder,'data','example_anomaly_circle_2d_results.mat'),'results');
