...
maxsz_reconstruction = model_parameters.radius/5;
...
num_of_electrodes_per_ring_vector = [4:8];
...
for i = 1:numel(imgs)
    ...
    data_aug = struct(...
        'num_of_elements',num_of_elements_array(i),...
        'num_of_sensors',num_of_sensors,...
        'num_of_measurements',num_of_measurements_eit_array(i)+3*num_of_measurements_mdeit_array(i), ...
        'rank',rank_aug(i), ...
        'random_seed',model_parameters_array(i).randomConductivitySeed,...
        'sensor_radius',model_parameters_array(i).sensorRadius,...
