classdef testJacobian < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function testJacobianComputation(testCase)
            %% Prepare workspace
            ...
            error_3d_percentage_1 = abs(num_1(:))./abs(den_1(:));
            error_3d_percentage_2 = abs(num_2(:))./abs(den_2(:));
            error_3d_percentage_3 = abs(num_3(:))./abs(den_3(:));
